...
export default function Hero() {
  return (
    <section className="hero-copy relative z-[1] mx-auto grid w-full max-w-6xl grid-cols-1 items-center gap-10 px-6 pb-16 pt-10 md:min-h-[calc(100svh-4rem)] md:grid-cols-12 md:gap-8 md:px-8 md:pb-20">
      <div className="md:col-span-6">
        ...
        <div className="arrive mt-9 flex flex-wrap gap-x-6 gap-y-3 text-sm" style={{ "--arrive-delay": "160ms" } as React.CSSProperties}>
          <a
            href={site.actions.primary.href}
            className="rounded-sm bg-fg px-4 py-2.5 font-semibold text-ink transition-colors hover:bg-facet-highlight"
          >
      ...
      <div className="order-first md:order-none md:col-span-6 md:col-start-7">
        <div className="arrive" style={{ "--arrive-delay": "240ms" } as React.CSSProperties}>
          <div id={HERO_SLOT_ID} className="hero-slot mx-auto max-h-[46svh] md:max-h-[70svh]">
          ...
          <p className="mt-8 text-center text-sm text-fg-faint md:mt-10">{caption}</p>
        </div>
      </div>
